            ...
            <div class="card">
              ...
              <div class="card-block text-center">
                <p class="card-text text-muted" style={{ padding: "20px" }}>
                  ...
                  <b style={{ color: "#588498" }}> freelance stylists </b> or
                  any type of stylist who wants to promote themselves.
                  <br />
                  <br />
                  The goal at <b style={{ color: "#588498" }}>Fancio </b> is to{" "}
                  <b style={{ color: "#588498" }}>
                    bridge a friendly connection between stylists and their
                    clients
                  </b>{" "}
                  , and to provide stylists a platform that is tailored for them
                </p>
                <Button type="button" className="btn-lg btn-info" onClick={this.onSubmit}>
                  Join Today!
                </Button>
                <p class="card-text">
                  <br />
